...
class Loggers():
    ...
    def on_train_batch_end(self, ni, model, imgs,imgs2, targets, paths,paths2, plots, sync_bn):
        ...
        if plots:
            ...
            if ni < 3:
                ...
                Thread(target=plot_images, args=(imgs,imgs2, targets, paths,paths2, f,f2), daemon=True).start()

...
output_address='H:/刘对虹/data/image/training\image_my\';
output_address2='H:/刘对虹/data/image/training\image_my2\';


for i=0:10%代表要处理的图片的第一张和最后一张
...
img_interp=interp_fx(img(:,:,4),[-5,5],[-7,7]);
img_interp2=interp_fx(img(:,:,5),[-5,5],[-7,7]);
inshow(img_interp);figure;
